...
class Coupon(models.Model):
    ...
    실제 사용되는 쿠폰입니다.
    """
    couponbook = models.ForeignKey("couponbook.models.CouponBook",
...
class Stamp(models.Model):
    ...
    related_payment = models.ForeignKey("payment.models.PaymentHistory",
                                        on_delete=models.CASCADE,
                                        help_text="해당 스탬프의 적립 근거가 되는 결제 내역입니다.")
    customer = models.ForeignKey("accounts.models.User", on_delete=models.CASCADE, help_text="스탬프를 적립받은 고객입니다.")